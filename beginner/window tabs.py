...
Label(tab1,text="Hello, this is tab 1",font=("mv boli",25), width=50,height=25).pack()
Label(tab2,text="Goodbye, this is tab 2",font=("mv boli",25),width=50,height=25).pack()
